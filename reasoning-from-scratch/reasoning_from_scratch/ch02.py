...
def generate_text_basic(model, token_ids, max_new_tokens, eos_token_id=None):
    ...
    for _ in range(max_new_tokens):
        ...
        # Yığındaki tüm diziler EOS ürettiyse dur
...
# Daha önce 2. bölüm akışsız bir fonksiyon kullanıyordu ve
# *_stream fonksiyonları alıştırmalarda tanıtılmıştı
# Daha basit olan generate_text_basic_cache artık kullanılmasa da
# geriye dönük uyumluluk nedeniyle burada tutuluyor
@torch.inference_mode()
