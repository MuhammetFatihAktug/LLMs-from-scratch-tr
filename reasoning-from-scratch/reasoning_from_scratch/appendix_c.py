...
QWEN3_CONFIG_1_7B = {
    ...
    "emb_dim": 2048,                 # 0.6B modelinin 2 katı
    "n_heads": 16,
    "n_layers": 28,
    "hidden_dim": 6144,              # 0.6B modelinin 2 katı
    "head_dim": 128,
    "qk_norm": True,
    "n_kv_groups": 8,
...
QWEN3_CONFIG_8B = {
    ...
    "n_heads": 32,
    "n_layers": 36,                  # Yukarıdakinden %26 büyük
    "hidden_dim": 12288,
    "head_dim": 128,
    "qk_norm": True,
    "n_kv_groups": 8,
...
def load_weights_into_qwen(model, param_config, params):
    ...
    # Model ağırlık paylaşımı (weight tying) kullanıyor, bu yüzden burada gömme katmanı ağırlıklarını yeniden kullanıyoruz
