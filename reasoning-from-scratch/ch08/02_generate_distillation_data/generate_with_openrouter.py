...
def content_to_text(value):
    ...
    if isinstance(value, dict):
        # Önce metin taşıyan yaygın anahtarları yeğle.
        preferred_keys = (
            "content",
            "text",
            "value",
        ...
        # Yeğlenen anahtarlar yoksa iç içe değerleri özyinelemeli incele,
        # ancak model metni içermesi beklenmeyen üst veri anahtarlarını atla.
        if not chunks:
            metadata_keys = {
                "id",
                "type",
...
def parse_openrouter_response(decoded):
    ...
    # Bazı modeller/sağlayıcılar yalnızca akıl yürütme benzeri metin açığa çıkarır.
