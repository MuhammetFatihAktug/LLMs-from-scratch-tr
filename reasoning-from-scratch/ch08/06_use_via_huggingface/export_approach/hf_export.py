...
def torch_dtype_to_name(dtype_value):
    # Sıfırdan yapılandırma, dtype'ları torch.bfloat16 gibi torch nesneleri olarak saklar,
    # ancak Hugging Face yapılandırması JSON olarak kaydedilir; bu yüzden config.json'a
    # yazmadan önce bunları "bfloat16" gibi dizelere dönüştürüyoruz.
