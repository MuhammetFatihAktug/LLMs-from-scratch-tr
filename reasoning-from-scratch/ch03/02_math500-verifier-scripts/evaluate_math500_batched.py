...
def evaluate_math500_batched(
    ...
    # Akışlı çeşide benzer varsayılan çıktı yolu
    if out_path is None:
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        for start in range(0, num_examples, batch_size):
            ...
            for b_idx in range(B):
                # evaluate_math500_stream içinde kullanılan değişken adlarıyla eşleş
                i = start + b_idx + 1
                row = batch[b_idx]

                row_tokens = gen[b_idx]
                # Varsa ilk EOS'ta kes
...
if __name__ == "__main__":
    ...
    if args.checkpoint_path:
        # 6. bölümdeki kaydedilmiş RL kontrol noktası dosyalarını yüklemek için
