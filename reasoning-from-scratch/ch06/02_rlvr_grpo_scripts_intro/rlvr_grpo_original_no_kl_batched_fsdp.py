...
def train_rlvr_grpo(
    ...
    try:
        for step in range(steps):
            ...
            # Bu, rank 0'ın yerel rollout uzunluğunun GPU sayısıyla ölçeklenmesine
            # dayalı bir tahmindir (rank'ler arası tam bir toplam değildir)
            tokens_per_sec = (
...
if __name__ == "__main__":
    ...
    if args.num_gpus > torch.cuda.device_count():
        raise ValueError("Requested --num_gpus exceeds available GPUs.")
