...
# Token düzeyi log-olasılıkları yansıtmak için sequence_logprob_and_entropy adından değiştirildi (DAPO)
# entropi artık günlükleme için isteğe bağlı.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="KL penalty coefficient; set to 0.0 to disable.",
    )
    parser.add_argument(
        "--seed",
        type=str,
